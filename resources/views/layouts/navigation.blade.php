<header x-data="{
    ...
    <div>
        <a href="{{ route('home') }}" class="block py-navbar-item pl-5"> Daraja Ecommerce </a>
    </div>
    <!-- Responsive Menu -->
                ...
                <ul @click.outside="open = false" x-show="open" x-transition x-cloak
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="{{ route('logout') }}" class="flex px-3 py-2 hover:bg-slate-900" onclick="event.preventDefault();
                                        this.closest('form').submit();">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
